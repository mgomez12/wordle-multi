...
router.get("/validGame", (req, res) => {
	...
	res.send({validGame: socketManager.gameExists(id), validSession:!socketManager.getGameFromUserID(user)});
...
router.post("/initsocket", (req, res) => {
  ...
  if (req.body.user) {
	if (!socketManager.gameExists(req.body.gameid)) {
		...
		res.statusCode = socketManager.addUser(req.body.user, req.body.gameid, req.body.playerName, socket);
